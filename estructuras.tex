...
Definimos el  \textbf{factor de balanceo} (FdB) de un nodo $x$ en un \'arbol como: $$FdB(x) = h(izq(x)) - h(der(x))$$ donde $izq$ y $der$ son los respectivos sub\'arboles de $x$, y $h$ es la altura de esos \'arboles.
...
%Falta ver inorder, preorder y postorder
